...
echo ""
echo "Port bindings:"
check_port 22222 "Endlessh tarpit"
...
echo "  Port 22222: Endlessh SSH tarpit"
...
echo ""
echo "Recommended next step: restrict honeypot outbound traffic"
echo "  sudo bash deploy/egress-firewall.sh"
echo ""
echo "Internal dashboards (access via SSH tunnel):"
echo "  ssh -L 8001:localhost:8001 -L 3000:localhost:3000 user@$(hostname -I | awk '{print $1}')"
